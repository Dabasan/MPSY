package com.github.maeda6uiui.mpsy;
...
public class MPSYMain {
    public static final String VERSION_STR = "MPSY v2.0.0";
    ...
    public static void main(String[] args) {
        ...
        var optionRY = new Option("ry", "rot-y", true, "Amount of rotation around the Y-axis");
        var optionRZ = new Option("rz", "rot-z", true, "Amount of rotation around the Z-axis");
        var optionR = new Option("r", "rot", true,
                "Amount of rotation around an arbitrary axis [amount, axisX, axisY, axisZ]");
        var optionZ = new Option("z", "invert-z", false, "Inverts Z-axis");
